...
namespace OWZX.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <param name="room"></param>
        /// <returns></returns>
        string AddUserBackRule(MD_UserBackRate rate);
        /// <summary>
        /// 更新佣金规则
        /// </summary>
        /// <param name="rate"></param>
        /// <returns></returns>
        string UpdateUserBackRule(MD_UserBackRate rate);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        string DeleteUserBackRule(string id);
        ...
        /// <param name="condition">没有where 主表 a  房间类型表 b </param>
        /// <returns></returns>
        DataTable GetUserBackRuleList(int pageNumber, int pageSize, string condition = "");
        #endregion
        #region 报表
        /// <summary>
        /// 盈利报表
