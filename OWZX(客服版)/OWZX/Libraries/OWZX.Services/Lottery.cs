...
namespace OWZX.Services
{
    public class Lottery
    {
        ...
        /// <param name="room"></param>
        /// <returns></returns>
        public static bool AddUserBackRule(MD_UserBackRate rate)
        {
            string result = OWZX.Data.Lottery.AddUserBackRule(rate);
            if (result.EndsWith("成功"))
            {
                return true;
            }
        ...
        /// <param name="rate"></param>
        /// <returns></returns>
        public static bool UpdateUserBackRule(MD_UserBackRate rate)
        {
            string result = OWZX.Data.Lottery.UpdateUserBackRule(rate);
            if (result.EndsWith("成功"))
            {
                return true;
            }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static bool DeleteUserBackRule(string id)
        {
            string result = OWZX.Data.Lottery.DeleteUserBackRule(id);
            if (result.EndsWith("成功"))
            {
                return true;
            }
        ...
        /// <param name="condition">没有where 主表 a  房间类型表 b </param>
        /// <returns></returns>
        public static List<MD_UserBackRate> GetUserBackRuleList(int pageIndex, int pageSize, string condition = "")
        {

            DataTable dt = OWZX.Data.Lottery.GetUserBackRuleList(pageIndex, pageSize, condition);
            List<MD_UserBackRate> list = (List<MD_UserBackRate>)ModelConvertHelper<MD_UserBackRate>.ConvertToModel(dt);
            return list;
        }
        #endregion
        #region 报表
