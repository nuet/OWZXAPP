...
namespace OWZX.Services
{
    public partial class NewUser
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<MD_Dummy> GetDummyUser(int pageNumber, int pageSize, string condition = "")
        {
            DataTable dt = OWZX.Data.NewUser.GetDummyUser(pageNumber, pageSize, condition);
            List<MD_Dummy> list = (List<MD_Dummy>)ModelConvertHelper<MD_Dummy>.ConvertToModel(dt);
            return list;
        }
