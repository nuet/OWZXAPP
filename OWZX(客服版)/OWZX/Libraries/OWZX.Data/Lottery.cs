...
namespace OWZX.Data
{
    public class Lottery
    {
        ...
        /// <param name="room"></param>
        /// <returns></returns>
        public static string AddUserBackRule(MD_UserBackRate rate)
        {
            return OWZX.Core.BSPData.RDBS.AddUserBackRule(rate);
        }
        /// <summary>
        /// 更新回水规则
        /// </summary>
        /// <param name="rate"></param>
        /// <returns></returns>
        public static string UpdateUserBackRule(MD_UserBackRate rate)
        {
            return OWZX.Core.BSPData.RDBS.UpdateUserBackRule(rate);
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static string DeleteUserBackRule(string id)
        {
            return OWZX.Core.BSPData.RDBS.DeleteUserBackRule(id);
        }
        ...
        /// <param name="condition">没有where 主表 a  房间类型表 b </param>
        /// <returns></returns>
        public static DataTable GetUserBackRuleList(int pageNumber, int pageSize, string condition = "")
        {
            return OWZX.Core.BSPData.RDBS.GetUserBackRuleList(pageNumber, pageSize, condition);
        }
        #endregion
        #region 报表
        /// <summary>
