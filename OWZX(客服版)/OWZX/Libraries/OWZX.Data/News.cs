...
namespace OWZX.Data
{
    ...
    public partial class News
    {
        ...
        public static DataTable GetUserBackList(int pageSize, int pageNumber, string condition)
        {
            return OWZX.Core.BSPData.RDBS.GetUserBackList(pageSize, pageNumber, condition);
        }
    }
}
