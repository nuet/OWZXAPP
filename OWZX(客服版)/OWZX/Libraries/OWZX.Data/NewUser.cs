...
namespace OWZX.Data
{
    public partial class NewUser
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable GetDummyUser(int pageNumber, int pageSize, string condition = "")
        {
            return OWZX.Core.BSPData.RDBS.GetDummyUser(pageNumber,pageSize,condition);
        }
